...
export class BaggagedataComponent implements OnInit {
  ...
  @ViewChild('pdfTable',{ static: true }) public pdfTable: ElementRef;
  ...
  date(StartTime: string){
    ...
    if (fechaFormateada == null) {
      ...
      this.http.get(this.api.apiUrlNode1 + '/GetNumberOfBags?reportdate='+ fechaFormateada)
